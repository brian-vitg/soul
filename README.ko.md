...
> ### 🚀 v6.0 업데이트 — Ark: 최후의 방패
>
> Soul v6.0에 **Ark**가 탑재되었습니다. 모든 도구 호출을 검사하고 위험한 행동을 **실행 전에** 차단하는 AI 안전 시스템입니다. LLM 호출 없음, 토큰 비용 0, 지연 없음 — MCP 서버 레벨의 순수 정규식 매칭.
>
> - 모든 도구 호출이 `ark.check()`를 통과 — **무조건**
